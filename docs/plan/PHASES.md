...
| **14c′** | **A big change is not a big file** — inserted by 14c's frozen rule | ⬜ **decided 23 Sep: ADR-0087 A** — one error per task, the same 27 tasks decomposed; exit check to be frozen before it runs · `v0.2.0` held | 2–3 sessions building, **attended** · then **one quiet 2–4 h run**, sized from probe 1 rather than called overnight · exit check **FROZEN 22 Sep**, `prompts/phase-14c-the-reach.md` |
